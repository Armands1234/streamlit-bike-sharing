...
def get_total_count_by_hour_df(hour_df):
    if "nama_kolom_yang_benar" in hour_df.columns:
        hour_count_df = hour_df.groupby(by="nama_kolom_yang_benar").agg({"count_cr": ["sum"]})
        return hour_count_df
    else:
        raise KeyError("Column 'nama_kolom_yang_benar' not found in the DataFrame.")
